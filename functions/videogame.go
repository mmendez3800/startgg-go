...
// GetVideogame provides either the data of the Videogame object received based on the parameters
// given or the error that resulted in the attempt.
func GetVideogame(key string, value interface{}) (*objects.StartGGVideogame, error) {
	...
	query, err := json.Marshal(createQuery(queries.VideogameQuery, key, value))
	if err != nil {
	...
	results := &objects.StartGGVideogame{}
