...
// GetShop provides either the data of the User object received based on the parameters
// given or the error that resulted in the attempt.
func GetShop(key string, value interface{}) (*objects.StartGGShop, error) {
	...
	query, err := json.Marshal(createQuery(queries.ShopQuery, key, value))
	if err != nil {
