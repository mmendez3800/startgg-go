...
// GetUser provides either the data of the User object received based on the parameters
// given or the error that resulted in the attempt.
func GetUser(key string, value interface{}) (*objects.StartGGUser, error) {
	...
	query, err := json.Marshal(createQuery(queries.UserQuery, key, value))
	if err != nil {
